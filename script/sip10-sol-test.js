...
const BRIDGE_VAULT_PDA = new PublicKey('APqctvRGYBXxgasti2vu6umGGpFqZN2bZnQSxeXG7GPS'); // Replace with your bridge vault address
...
const SOL_RECIPIENT = new PublicKey('GoE3DAzPgseGUFAn9ufQjgKdQ1jAoL6LUtgMEzmN9EZ7'); // Replace with recipient Solana address
...
try {
    ...
    const tx = await program.methods.unlock(new anchor.BN(amount))
        .accounts({
              pda,
            recipient: SOL_RECIPIENT,
            systemProgram: SystemProgram.programId,
